        ...
        public static IHtmlContent RenderAlert(this IHtmlHelper helper, string tempData)
        {
            ...
            return
                new HtmlString(String.Format(
                    "<div class='row'> <div class='col-md-12'> <div class='alert alert-{0} alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>{1}</strong>{2}</div> </div> </div>",
